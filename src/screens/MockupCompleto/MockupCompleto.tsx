    ...
    <div className="bg-white flex flex-row justify-center w-full">
      ...
      <div className="bg-white overflow-x-hidden w-full relative">
        ...
        */}
        ...
        <div className="w-full h-auto py-20 [background:url(/relatos.png)_50%_50%_/_cover,linear-gradient(0deg,rgba(241,244,248,1)_0%,rgba(241,244,248,1)_100%)]"> {/* Ajustado altura para auto e adicionado padding vertical */}
          <Card className="border-none shadow-none bg-transparent max-w-6xl mx-auto"> {/* Adicionado max-width e centralização */}
            <CardContent className="flex flex-col items-center justify-center h-full p-4 md:p-0"> {/* Adicionado padding responsivo */}
              <h2 className="font-h1-lato font-[number:var(--h1-lato-font-weight)] text-azul-marinho text-[length:var(--h1-lato-font-size)] text-center tracking-[var(--h1-lato-letter-spacing)] leading-[var(--h1-lato-line-height)] [font-style:var(--h1-lato-font-style)] mb-16 md:mb-24"> {/* Aumentado margin bottom */}
                Convênios atendidos
              </h2>

              {/* Container dos logos com wrap */}
              <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 md:gap-x-16 lg:gap-x-20"> {/* Adicionado flex-wrap e ajustado gaps */}
                {partnerLogos.map((logo, index) => (
                  <img
                    key={index}
                    // Ajustando classes para responsividade e altura máxima
