...
export const HeroSection = (): JSX.Element => {
  ...
  return (
    <section
      className="relative w-full h-screen [background:linear-gradient(180deg,rgba(0,59,115,0.4)_0%,rgba(0,0,0,0)_100%),linear-gradient(90deg,rgba(0,59,115,0.65)_0%,rgba(241,244,248,0)_100%),url(/wireframe---landing-page.png)_50%_50%_/_cover] bg-center bg-cover"
    >
      <div className="container flex flex-col w-full max-w-[608px] items-start gap-8 absolute bottom-12 md:bottom-16 left-1/2 md:left-auto -translate-x-1/2 md:translate-x-0 md:ml-16 lg:ml-24 px-4 md:px-0">
        ...
        <div className="w-full flex justify-center md:justify-start">
          <Button
            asChild
            className="bg-dourado hover:bg-dourado/90 rounded-[15px] px-6 py-2 shadow-[0px_4px_4px_#00000040] h-auto 
